# tasks-legacy.md — 멀티테넌트 전환 작업 목록 (보존 전용)

> **주의**: 본 파일은 2026-04-27 기준 **레거시 실행 체크리스트**다.  
> 현행 **감사 ID**(`SUP-*`, `RES-*`, `ADM-*`, `DB-*`) 및 Phase 0 로드맵은 **`tasks.md`**만 본다.  
> 두 문서를 한 스프린트 계획에 섞지 말 것.

---

# RealMyOS — tasks.md (legacy)
