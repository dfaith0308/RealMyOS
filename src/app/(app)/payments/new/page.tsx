...
export default function PaymentNewPage({
  ...
  return (
    <main style={{ minHeight: '100vh', background: 'var(--surface-0)', paddingTop: 40 }}>
      <div style={{ maxWidth: 480, margin: '0 auto', background: 'var(--surface-2)', border: '1px solid var(--border)', borderRadius: 12, padding: '32px 28px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
